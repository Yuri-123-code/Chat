          ...
          <div class="content-wrapper">
            <div class="row">
                ...
                <form action="<?php print $_SERVER['PHP_SELF']; ?>" method="post">
                    <div class="search-typ">
                        <input class="search ml-2" type="search" name="search" placeholder="Pesquisar por nome">
                        <button type="submit" class="btn btn-primary search-btn mr-2" name="send">
                             <i class="fa fa-search"></i>
                        </button>
                     </div>
                </form>
